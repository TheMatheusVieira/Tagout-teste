  ...
  return (
    <div className="flex relative flex-col items-center justify-center gap-5 min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="w-45 h-full bg-gray-50 absolute rotate-20 origin-top-right border-l-2 right-0 scale-x-150 scale-y-125" />
      </div>
      ...
      <button type="button" className="bg-red text-white font-semibold text-xl w-40 h-10 rounded-md z-10">
        ENTRAR
      </button>
    </div>
  );
