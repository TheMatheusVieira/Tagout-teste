...
<div className="flex flex-col w-full">
    ...
    <div className="flex flex-row">
       ...
       <div className="flex flex-row w-150 justify-between ml-25 items-center">
        ...
        <div className="w-150 ml-60 mt-15 relative">
            <h1 className="text-lg flex items-center font-bold">Todas manutenções em andamento</h1>
        ...
        <div className="w-150 ml-25 mt-10 font-bold flex flex-row justify-between">
           <h1 className="text-lg flex items-center">Quantidade de tarefas em execução</h1>
